...
<body>
    ...
    <h3 class="pageTitleH3">Add a New Code</h3>

    <table class="tableDataGrid" style="width: 700px;">
        <tr>
            <th width="136"><span class="c-c60000 txtNormal">*</span> 코드 ID</th>
    ...
    <table class="tableBtn" style="width: 700px;">
        <tr>
            <td align="left">
                <table><tr><td><table class="btnTypeC"><tr><td><a href="#">List</a></td></tr></table></td></tr></table>
            </td>
            <td align="right">
                <table>
                    <tr>
